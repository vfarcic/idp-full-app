...
def "main build image" [
    ...
    docker image build --tag $"ghcr.io/vfarcic/idp-full-app:latest" .
    docker image tag $"ghcr.io/vfarcic/idp-full-app:latest" $"ghcr.io/vfarcic/idp-full-app:($tag)"
    if $push {
        docker image push $"ghcr.io/vfarcic/idp-full-app:latest"
        docker image push $"ghcr.io/vfarcic/idp-full-app:($tag)"
    }
}
# Updates the claim
